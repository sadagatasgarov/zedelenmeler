...
from Naxcivan.models import Ats, Idare, KomekciPaylayiciSkaf, KomekciPaylayiciSkafdakiKabelNomreleri, Montyor, Muqavile, OlculmusZedeninXususiyyeti, PaylayiciSkaf, Nomreler, Tehkimolunma, PaylayiciSkafdakiKabelNomreleri, \
