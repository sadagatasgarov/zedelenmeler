...
class Idare(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Qeydə alan", related_name='Sederek_Idare')
    qeydə_alinma_tarixi = models.DateTimeField(blank=True, null=True, auto_now_add=True)
    user2 = models.ForeignKey(User, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Sonuncu defe düzəliş edən", related_name='Sederek_Idare2')
...
class Ats(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Qeydə alan", related_name='Sederek_Ats')
    qeydə_alinma_tarixi = models.DateTimeField(blank=True, null=True, auto_now_add=True)
    user2 = models.ForeignKey(User, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Sonuncu defe düzəliş edən", related_name='Sederek_Ats2')
    sonuncu_duzəlis_tarixi = models.DateTimeField(null=True, blank=True, auto_now_add=True, verbose_name="Sonuncu duzəliş tarixi")
...
class Montyor(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Qeydə alan", related_name='Sederek_Montyor')
    qeydə_alinma_tarixi = models.DateTimeField(blank=True, null=True, auto_now_add=True)
    user2 = models.ForeignKey(User, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Sonuncu defe düzəliş edən", related_name='Sederek_Montyor2')
    sonuncu_duzəlis_tarixi = models.DateTimeField(null=True, blank=True, auto_now_add=True, verbose_name="Sonuncu duzəliş tarixi")
...
class PaylayiciSkaf(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Qeydə alan", related_name='Sederek_PaylayiciSkaf')
    qeydə_alinma_tarixi = models.DateTimeField(blank=True, null=True, auto_now_add=True)
    user2 = models.ForeignKey(User, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Sonuncu defe düzəliş edən", related_name='Sederek_PaylayiciSkaf2')
    sonuncu_duzəlis_tarixi = models.DateTimeField(null=True, blank=True, auto_now_add=True, verbose_name="Sonuncu duzəliş tarixi")
...
class PaylayiciSkafdakiKabelNomreleri(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Qeydə alan", related_name='Sederek_PaylayiciSkafdakiKabelNomreleri')
    qeydə_alinma_tarixi = models.DateTimeField(blank=True, null=True, auto_now_add=True)
    user2 = models.ForeignKey(User, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Sonuncu defe düzəliş edən", related_name='Sederek_PaylayiciSkafdakiKabelNomreleri2')
    sonuncu_duzəlis_tarixi = models.DateTimeField(null=True, blank=True, auto_now_add=True, verbose_name="Sonuncu duzəliş tarixi")
...
#    tabe_oldugu_idare = models.ForeignKey(Idare, on_delete=models.PROTECT, blank=True, null=True)
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Qeydə alan", related_name='Sederek_KomekciPaylayiciSkaf')
    qeydə_alinma_tarixi = models.DateTimeField(blank=True, null=True, auto_now_add=True)
    user2 = models.ForeignKey(User, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Sonuncu defe düzəliş edən", related_name='Sederek_KomekciPaylayiciSkaf2')
    sonuncu_duzəlis_tarixi = models.DateTimeField(null=True, blank=True, auto_now_add=True, verbose_name="Sonuncu duzəliş tarixi")
...
class KomekciPaylayiciSkafdakiKabelNomreleri(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Qeydə alan", related_name='Sederek_KomekciPaylayiciSkafdakiKabelNomreleri')
    qeydə_alinma_tarixi = models.DateTimeField(blank=True, null=True, auto_now_add=True)
    user2 = models.ForeignKey(User, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Sonuncu defe düzəliş edən", related_name='Sederek_KomekciPaylayiciSkafdakiKabelNomreleri2')
    sonuncu_duzəlis_tarixi = models.DateTimeField(null=True, blank=True, auto_now_add=True, verbose_name="Sonuncu duzəliş tarixi")
...
class Muqavile(models.Model):
    ...
    qeyd = models.CharField(max_length=50, blank=True, null=True, verbose_name="Qeyd")
    user = models.ForeignKey(settings.AUTH_USER_MODEL, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Qeydə alan", related_name='Sederek_Muqavile')
    qeydə_alinma_tarixi = models.DateTimeField(blank=True, null=True, auto_now_add=True)
    user2 = models.ForeignKey(User, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Sonuncu defe düzəliş edən", related_name='Sederek_Muqavile2')
    sonuncu_duzəlis_tarixi = models.DateTimeField(null=True, blank=True, auto_now_add=True, verbose_name="Sonuncu duzəliş tarixi")
...
class Tehkimolunma(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Qeydə alan", related_name='Sederek_Tehkimolunma')
    qeydə_alinma_tarixi = models.DateTimeField(blank=True, null=True, auto_now_add=True)
    user2 = models.ForeignKey(User, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Sonuncu defe düzəliş edən", related_name='Sederek_Tehkimolunma2')
    sonuncu_duzəlis_tarixi = models.DateTimeField(null=True, blank=True, auto_now_add=True, verbose_name="Sonuncu duzəliş tarixi")
...
class Nomreler(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Qeydə alan", related_name='Sederek_Nomreler')
    qeydə_alinma_tarixi = models.DateTimeField(blank=True, null=True, auto_now_add=True)
    user2 = models.ForeignKey(User, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Sonuncu defe düzəliş edən", related_name='Sederek_Nomreler2')
    sonuncu_duzəlis_tarixi = models.DateTimeField(null=True, blank=True, auto_now_add=True, verbose_name="Sonuncu duzəliş tarixi")
# Diğer alanlar
    def esas_skaf(self):
...
class ZedelenmeninXarakteristikasi(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Qeydə alan", related_name='Sederek_ZedelenmeninXarakteristikasi')
    qeydə_alinma_tarixi = models.DateTimeField(blank=True, null=True, auto_now_add=True)
    user2 = models.ForeignKey(User, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Sonuncu defe düzəliş edən", related_name='Sederek_ZedelenmeninXarakteristikasi2')
    sonuncu_duzəlis_tarixi = models.DateTimeField(null=True, blank=True, auto_now_add=True, verbose_name="Sonuncu duzəliş tarixi")
...
class OlculmusZedeninXususiyyeti(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Qeydə alan", related_name='Sederek_OlculmusZedeninXususiyyeti')
    qeydə_alinma_tarixi = models.DateTimeField(blank=True, null=True, auto_now_add=True)
    user2 = models.ForeignKey(User, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Sonuncu defe düzəliş edən", related_name='Sederek_OlculmusZedeninXususiyyeti2')
    sonuncu_duzəlis_tarixi = models.DateTimeField(null=True, blank=True, auto_now_add=True, verbose_name="Sonuncu duzəliş tarixi")
...
class ZedelenmelerinQeydiyyatiJurnali(models.Model):
    ...
    operator = models.ForeignKey(settings.AUTH_USER_MODEL, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Qeydə alan", related_name='Sederek_ZedelenmelerinQeydiyyatiJurnali')
    operator2 = models.ForeignKey(User, blank=True, null=True, on_delete=models.CASCADE, verbose_name="Sonuncu defe düzəliş edən", related_name='Sederek_ZedelenmelerinQeydiyyatiJurnali2')
